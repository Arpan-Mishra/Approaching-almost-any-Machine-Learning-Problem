...
def run(fold):
    ...
    # cat cols
    cat_features = [f for f in df.columns if f not in num_cols+['income','kfold']]
...
# this improves the model performance
# a very naive approach to create features, should either select
# features after EDA or create features using greedy approach and 
